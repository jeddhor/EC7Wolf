...
| [`editor/`](editor/) | EC7Edit, the level editor being built to that plan. No GUI yet: the native codec, the preview-WAD exporter and the `ec7edit` command line, with the byte layouts documented in [`editor/docs/native-formats.md`](editor/docs/native-formats.md). |
