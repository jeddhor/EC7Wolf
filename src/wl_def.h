...
// Corridor 7 rotates its four eight-color VGA ramps (208..239) to animate the
// blinking and traveling lights baked into wall, sprite and weapon artwork.
...
// ramp-colored wall in view, and a capture there reads a wandering actor
