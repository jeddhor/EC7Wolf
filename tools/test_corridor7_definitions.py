...
require(r'trigger\s+106\s*\{.*?action\s*=\s*"Door_Open".*?arg2\s*=\s*-1', XLAT, "marker-106 walls toggle in place")
require(r'oldplane\[i\]\s*==\s*106.*?maskedWallType.*?trigger\.action\s*=\s*Specials::Wall_Remove', GAMEMAP_PLANES, "masked marker-106 force fields disappear without sliding")
